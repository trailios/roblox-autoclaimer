    ...
    "embeds": [
        {
            ...
            "footer": {"text": "Made by: TK aka Traili your favourite developer", "icon_url": "https://cdn.discordapp.com/avatars/1137484045501092012/4ea0960613ba5ac4dc18ccc95fe34b70.webp?size=1024&format=webp&width=0&height=256",},
            "thumbnail": {"url": "https://cdn.discordapp.com/avatars/1137484045501092012/4ea0960613ba5ac4dc18ccc95fe34b70.webp?size=1024&format=webp&width=0&height=256"},
            "color": 0x3498DB,
        }
    ]
}
...
def leave(groupid, cookie, xcsrf_token):
    ...
    res2 = requests.get(f"https://users.roblox.com/v1/users/authenticated", headers=headers)
    userid = res2.json()["id"]
            ...
            "embeds": [
                {
                    ...
                    "description": f"traili doesnt have detection cause nigga is lazy\nJoined and claimed in {round(time2 - time1, 2)} seconds",
                    "footer": {
...
async def getgroup():
    ...
    if r.status_code == 200:
        ...
        if jsonn:
            ...
            if "roblox.com/groups/" in content1 or "www.roblox.com/groups/" in content1:
                await main(numbers_only[0])
            else:
                ...
